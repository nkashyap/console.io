    ...
    try {
        ...
        if (webapis.recognition.IsGestureRecognitionEnabled()) {
            ...
            var helpBarGesture = {
                ...
                itemList: [{
                    itemType: "EVENT_GESTURE_BEGIN_MONITOR",
                    itemText: "Start"
                }, {
                    itemType: "EVENT_GESTURE_SECONDARY_DETECT",
                    itemText: "Detect"
                }, {
                    itemType: "EVENT_GESTURE_SECONDARY_LOST",
                    itemText: "Lost"
                }, {
                    itemType: "EVENT_GESTURE_2HAND_ZOOM",
                    itemText: "Zoom"
                }, {
                    itemType: "EVENT_GESTURE_2HAND_ROTATE",
                    itemText: "Rotate"
                }, {
                    itemType: "EVENT_GESTURE_LIKE",
                    itemText: "Like"
                }]
            };
